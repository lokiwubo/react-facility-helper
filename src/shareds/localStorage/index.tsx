...
import { createDeepReactiveProxy, shallowCompareValues } from "ts-utils-helper";
...
>(
  ...
  const useLocalStorage = function <TSelector extends SelectorType>(
    selector?: TSelector,
  ) {
        ...
        return container.subscribe((curData, preData) => {
          ...
          if (
            !shallowCompareValues(
              getSelectorData(curData),
              getSelectorData(preData),
            )
          ) {
            onStoreChange();
          }
